...
export class Backend implements backendInterface {
    ...
    async getAllContactsByCompany(): Promise<Array<Contact>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllContactsByCompany();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async isContactSubmitted(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isContactSubmitted();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
